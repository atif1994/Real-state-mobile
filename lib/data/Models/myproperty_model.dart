...
//
//     final myProperty = myPropertyFromJson(jsonString);

import 'dart:convert';

MyProperty? myPropertyFromJson(String str) =>
    MyProperty.fromJson(json.decode(str));

String myPropertyToJson(MyProperty? data) => json.encode(data!.toJson());
