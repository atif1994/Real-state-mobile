...
// import 'package:prologic_29/data/Controllers/post_like_controller/post_like_controller.dart';
...
//             itemCount: newsfeedController.newsfeedmodel.data?.data?.length,
//             itemBuilder: (context, index) {
//               _controllers.add(TextEditingController());
//               return Column(
//                 children: [
//                   Obx(
//                     () => newsfeedController.loadingnewspost.value
//                         ? Center(
...
//                               likeController.getPostLike(
//                                   newsfeedController
//                                       .newsfeedmodel.data!.data![index].id
//                                       .toString(),
//                                   uid!);
//                               setState(() {});
//                             },
...
//                           InkWell(
//                             onTap: () async {
//                               latestCommentsController.getComments(2);
...
//                   Padding(
//                     padding:
//                         EdgeInsets.only(right: 4.0.w, left: 4.0.w, top: 2.0.h),
//                     child: Row(
//                       mainAxisAlignment: MainAxisAlignment.spaceAround,
//                       children: [
//                         Expanded(
...
=======
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              _controllers.add(TextEditingController());
>>>>>>> 8bb55aef6c6ffb8586f17fd17f3bdd7a64524ddf
                                      ...
                                      children: [
                                        IconButton(
                                            onPressed: () async {
                                              ...
                                              print(
                                                  "detector call ====$d======${newsfeedController.newsfeedmodel.data!.data![index].likesOnProperties?[0].isliked}");
                                              // setState(() {
                                              //   newsfeedController
                                              //       .getnewsfeed(pagekey);
                                              // });
