    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(children: [
          ...
          Padding(
            padding: const EdgeInsets.only(left: 10.0, right: 11.0),
            child: Container(
              child: Column(
                children: [
                  Padding(
                          ...
                          Container(
                            child: Text(
                              ...
                              style: AppTextStyles.heading1.copyWith(
                                  color: AppColors.colorblack, fontSize: 12),
                            ),
                          ),
                        ],
                      ),
                  ...
                  Container(
                    child: const Padding(
                      ...
                      child: Text(
                          'Ipsum is simply d4mmy text of the printing and typesetting industry. Lorem Ipsum has been the industry s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum'),
                    ),
                  ),
                  SizedBox(
                    height: 1.0.h,
                    ...
                    child: Container(
                      child: Row(
                        ...
                        children: [
                          ...
                          Image.asset(
                            AppImageResources.linkedinlogo,
                            // color: AppColors.appthem,
                            height: 3.0.h,
                          ),
                        ],
